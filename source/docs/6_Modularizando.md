...
<html lang="es">
  <head>
    ...
    <script src="/lib/bootstrap/index.js" defer></script>
    ...
    <!-- Global sources -->
...
> [!TIP]
> En los `scripts`, se utiliza el atributo `defer`
> para que el script se ejecute después de que el
> documento HTML se haya cargado.
